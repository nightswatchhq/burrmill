...
| 6.6 | `FoldSubstitution` **· LANDED 2026-09-24, ahead of 6.4/6.5; gate still missed, by about 1.5x** | Owned fold swapped in by an analyzer rule wherever its answer provably equals DataFusion's (NULL-rejecting filter or non-null values, strict `TRY_CAST`, 38-digit check), visible in EXPLAIN, parity by digest. 989,690 groups: **381-404 MB, 124 ms**, against stock 590 MB/100 ms and 6.3's 606-745. The rest is the collected answer; needs a streaming `Engine` and thinkpad figures |
