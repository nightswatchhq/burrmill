...
| 4.1c | **Composite keys and several aggregates** · the last 2 of 8 | 41 of 65 statement refusals are "projects exactly the key and the sum; got N items", N from 3 to 13, and 2 of the 7 remaining folds. Real views carry several aggregates and passthrough columns |
