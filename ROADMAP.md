...
| # | Work | Done when |
|---|---|---|
| 1.1 | Explain DuckDB's flat ~620 ms on the real nest directory | Either the cause is named and the ratios stand, or the comparison is corrected and the published numbers are restated **downward** |
...
**1.1 first**, because it is an evening's work and it decides whether the best numbers already
published are real. Publishing a flattering measurement and defending it later is the failure mode
