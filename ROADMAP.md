...
| 5.5 | The last of the throughput gap | 112 qps against a work-bound of ~151, so ~74% utilised; DuckDB reaches 168, above our work-bound, so it is both ~10% cheaper per query and better utilised. Closing it needs work-stealing **across** queries rather than nested rayon pools — a scheduler, not a constant. Worth costing before starting |
